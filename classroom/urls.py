...
urlpatterns = [
    ...
    path('my-course-request/',views.myCorseRequestGenericApiView.as_view(), name='my-course-request'),
    path('my-course-create/',views.myCorseCreateGenericApiView.as_view(), name='my-course-create'),
    path('proposal-courses/',views.ProposalCourseGenericApiView.as_view(), name='proposal-course'),
    path('proposal-recieve/<int:pk>',views.ProposalReceiveGenericApiView.as_view(), name='proposal-recieve'),
    path('proposal-send/',views.ProposalsSendGenericApiView.as_view(), name='proposal-send'),
    path('my-proposal-send/<int:pk>/',views.MYProposalSendGenericApiView.as_view(), name='my-proposal-send'),
