    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Mastery', models.CharField(choices=[('Beginner', 'beginner'), ('Intermediate', 'intermediate'), ('Proficient', 'proficient'), ('Advanced', 'advanced'), ('Expert', 'expert')], max_length=50)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('employee', 'Employee'), ('user_log', 'User')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_custom.skills')),
            ],
        ),
    ]
